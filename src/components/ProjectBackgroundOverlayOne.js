...
const ProjectBackgroundOverlayOne = () => {
  return (
    <>
              ...
              <div className='wrapper'>
                <div className='main-text'>
                  ...
                  <p>
                    ...
                    a metus pellentesque, scelerisque ex sed, volutpat nisi.
                    Curabitur tortor mi, eleifend ornare lobortis non. Nulla
                    porta purus quis iaculis ultrices. Proin aliquam sem at nibh
        ...
        <div className='box-text'>
          <div>
            <div className='wrapper-left'>
              ...
              <div className='icon-file'>
                <img src='./assets/img/icons/icon-20.svg' alt='Roralex' />
              </div>
              <p>
                Uisque molestie, arcu et iaculis mollis orci lacus facilisis
                pede
              </p>
            </div>
          </div>
          ...
          <div>
            <div className='wrapper-right'>
              ...
              <div className='icon-file'>
                <img src='./assets/img/icons/icon-22.svg' alt='Roralex' />
              </div>
              <p>
                Uisque molestie, arcu et iaculis mollis orci lacus facilisis
                pede
...
export default ProjectBackgroundOverlayOne;

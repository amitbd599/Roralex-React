            ...
            <div className='right-side'>
              <div className='wrapper'>
                ...
                <div className='inner-intro'>
                  ...
                  <p>
                    If your Comprehensive Car Insurance mentions ‘Agency Repair’
                    then your car is going to be repaired at the dealership from
                    where you purchased the car. This service is safe and
                    reliable but can be expensive too.
                  </p>
                  <ul>
                    <li>
                      <FaCheckCircle />

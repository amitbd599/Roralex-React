...
const BlogSectionTwo = () => {
  return (
    <>
      ...
      <section className='blog-section-version-two bg-gray py-80'>
              ...
              <div className='col-12'>
                <div className='wrapper'>
                  <div className='pop-text'>
                    <h3>We Are Providing latest news</h3>
                    <h2>LATEST NEWS</h2>
                  </div>
                </div>
              </div>
        ...
        {/* Blog Card Items */}
        <div className='blog-card-version-two'>
          <div className='container'>
            <div className='row'>
                ...
                <div className='wrapper shadow'>
                  ...
                  <div className='inner-file'>
                    ...
                    <div className='inner-text'>
                      <h2>
                        How to estimate structural steel for construction.
                      </h2>
                      <p>
              ...
              <div className='col-lg-4 col-md-6'>
                <div className='wrapper shadow'>
                  ...
                  <div className='inner-file'>
                    ...
                    <div className='inner-text'>
                      <h2>
                        There May Be Variations As Every Project Is Unique.
                      </h2>
                      <p>
                        Home renovations, especially those involving plentiful
                        of demolition can be a very dusty affair.

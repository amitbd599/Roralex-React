...
const PricingInner = () => {
  return (
    <>
      ...
      <section className='price-section-version-three bg-white pt-40 py-80'>
        {/* Price Card Items */}
        ...
        <div className='container'>
          <div className='row'>
            <div className='col-12'>
              <div className='wrapper'>
                <h2>
                  We Are Ready To <span className='theme-color'>Work</span> With
                  You
                </h2>
                <p>
            ...
            <div className='row'>
              <div className='col-lg-2 col-md-4 col-6'>
                <div className='wrapper'>
                  <img
                    className='img-fluid'
                    src='./assets/img/brand/image3.png'
                    alt=''
                  />
                </div>
              </div>
              <div className='col-lg-2 col-md-4 col-6'>
                <div className='wrapper'>
                  <img
                    className='img-fluid'
                    src='./assets/img/brand/image4.png'
                    alt=''
                  />
                </div>
              </div>
              <div className='col-lg-2 col-md-4 col-6'>
                <div className='wrapper'>
                  <img
                    className='img-fluid'
                    src='./assets/img/brand/image5.png'
                    alt=''
                  />
                </div>
              </div>
              <div className='col-lg-2 col-md-4 col-6'>
                <div className='wrapper'>
                  <img
                    className='img-fluid'
                    src='./assets/img/brand/image6.png'
                    alt=''
                  />
                </div>
              </div>
              <div className='col-lg-2 col-md-4 col-6'>
                <div className='wrapper'>
                  <img
                    className='img-fluid'
                    src='./assets/img/brand/image7.png'
                    alt=''
                  />
                </div>
              </div>
              <div className='col-lg-2 col-md-4 col-6'>
                <div className='wrapper'>
                  <img
                    className='img-fluid'
                    src='./assets/img/brand/image8.png'
                    alt=''
                  />
                </div>
              </div>

                      ...
                      <div className='content'>
                        <div className='heading-text '>
                          <h2 className='text-center'>
                            Construction is an{" "}
                            <span className='theme-color'>ancient</span> human
                            activity
                          </h2>
                          <p className='text-center'>
                            Human shelters were at first very simple and perhaps
                            lasted only a few days or months. Over time,
                            however, even temporary structures evolved into such
                            highly refined forms as the igloo.
                          </p>
                    ...
                    <div className='col-12'>
                      <div className='content'>
                        <div className='heading-text '>
                          <h2 className='text-center'>
                            There may be{" "}
                            <span className='theme-color'>variations</span> as
